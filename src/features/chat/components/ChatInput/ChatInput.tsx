...
export function ChatInput({ onSend }: ChatInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-2 md:p-4 bg-gradient-to-b from-[#2a2f3e]/90 to-[#1a1f2e]/90">
      <div className="relative flex flex-col md:flex-row gap-2 md:gap-4">
        <div className="flex-1 relative group">
          ...
          <textarea
            ...
            className="w-full rounded-lg bg-[#2a2f3e]/90 border-2 border-[#ff6b00]/20 px-4 py-2 pr-12 text-[#ffa066] placeholder-[#ffa066]/50 focus:outline-none focus:border-[#ff6b00]/50 resize-none min-h-[44px] max-h-32 transition-all duration-200 relative text-sm md:text-base"
            rows={1}
          />
        ...
        <button
          ...
          className={`${
            input.trim() 
              ...
              : 'bg-[#2a2f3e]'
          } text-white px-4 md:px-6 py-2 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 group relative`}
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#ff6b00] to-[#3a3f4e] rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200" />
      ...
      <div className="mt-2 text-xs text-[#ffa066]/70 italic text-center md:text-left">
